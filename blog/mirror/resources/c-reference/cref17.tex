...
%% (jashankj, 2017-07-30)	COMP1511 uses `dcc'.
...
%% (jashankj, 2017-07-30)	COMP1511 only uses `static'.
...
%% (jashankj, 2017-07-30)	No `break', `continue', or `goto' in COMP1511.
...
%% (jashankj, 2017-07-30):	No function pointers in COMP1511.
