...
int main (void) {
    ("Welcome to Dracula AI's testing centre");
    /////////////////////////////////////////////////////////
    DraculaView dv;
    char *msg = "HAHA";
    char *pastPlays;
    ...
    printf("It should return MILAN but it returns %d\n", dracula_getMoveTowardsRegion(dv, region, currLocation))
    TEST_MSG(Test_1: Testing getMoveTowardsRegion, dracula_getMoveTowardsRegion(dv, region, currLocation) == location_t);
